...
class EveApplication extends KoaApplication {
    ...
    init() {
        ...
        let response = new Response(this.options);
        ...
        let errorHandle = require('./../midldleware/error-handle');
        ...
        //允许制定前置 中间键
        let preMiddles = this.options.middles;
        if (preMiddles) {
