...
function RestRegClient(options) {
  ...
  this.groupName = options.groupName || "cloudark";
...
RestRegClient.prototype.downloadService = function () {
  ...
  let rUrl = this.regServer + "/ark/apps";
...
RestRegClient.prototype.registerService = function () {
  ...
  logger.info(`Register ${this.appName} to registry...`);

  const regUrl = `${this.regServer}/ark/apps/${this.appName}`; //?name=${this.appName}&host=${this.myHost}&port=${this.myPort}`;
  //const regUrl = `${this.regServer}/register?name=${this.appName}&host=${this.myHost}&port=${this.myPort}`;
  let _this = this;
  request.post({
    url: regUrl,
    json: {
...
RestRegClient.prototype.heartbeat = function () {
  ...
  let beatUrl = `${this.regServer}/ark/apps/${this.appName}/${this.instanceId}`;
