  ...
  this.socket.on("data", (data)=> {
    ...
    if (d_index > -1) {
      ...
      try {
        ...
        if (jsonInfo.errno != 0) {
          ...
          switch (jsonInfo.cmd) {
            case 'login':
              ...
              cmdRegService(this.socket, this.app_name, this.app_host, this.app_port, this.app_base_uri, this.not_a_consumer);
        ...
        tools.error("错误的数据，必须提供 json 格式的数据。" + chunk);
      }
    }
  });
